...
#include "nonEqSmoluchowskiJumpTvMixFvPatchScalarField.H"
...
// Map from self
void Foam::nonEqSmoluchowskiJumpTvMixFvPatchScalarField::autoMap
(
...
void Foam::nonEqSmoluchowskiJumpTvMixFvPatchScalarField::rmap
(
...
void Foam::nonEqSmoluchowskiJumpTvMixFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::nonEqSmoluchowskiJumpTvMixFvPatchScalarField::write(Ostream& os) const
{
    ...
    os.writeEntryIfDifferent<word>("gammatr", "gammatr", gammatrName_);
