...
// Map from self
void Foam::nonEqSmoluchowskiJumpTFvPatchScalarField::autoMap
(
...
void Foam::nonEqSmoluchowskiJumpTFvPatchScalarField::rmap
(
...
void Foam::nonEqSmoluchowskiJumpTFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void Foam::nonEqSmoluchowskiJumpTFvPatchScalarField::write(Ostream& os) const
{
